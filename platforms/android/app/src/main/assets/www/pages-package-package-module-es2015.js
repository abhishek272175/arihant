...
/* harmony import */ var _package_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./package.page */ "./src/app/pages/package/package.page.ts");
...
/* harmony import */ var _package_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./package-routing.module */ "./src/app/pages/package/package-routing.module.ts");
/* harmony import */ var _package_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./package.page */ "./src/app/pages/package/package.page.ts");
...
let PackagePage = class PackagePage {
    constructor(authService, storage, router, navCtrl, modalCtrl, alertService) {
            ...
            this.authService.getToken().then(isLoggedIn => {
                if (isLoggedIn != null) {
                    this.storage.get('user_id').then((val) => {
                        ...
                        this.authService.payment(this.user_id, payment_id, amount, product_id).subscribe(data => {
...
PackagePage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./package.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/package/package.page.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./package.page.scss */ "./src/app/pages/package/package.page.scss")).default]
    }),
...
//# sourceMappingURL=pages-package-package-module-es2015.js.map