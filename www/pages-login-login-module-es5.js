...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-login-login-module"], {
  ...
  function srcAppPagesLoginLoginTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function LoginPage(authService, navCtrl, alertService, modalCtrl, userData, router, events) {
      ...
      _createClass(LoginPage, [{
        ...
        value: function onLogin(form) {
          ...
          if (form.valid) {
            this.authService.login(this.login.username, this.login.password).subscribe(function (data) {
