...
const routes = [
    ...
    {
        path: 'about',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-about-about-module */ "default~pages-about-about-module~pages-tabs-page-tabs-page-module").then(__webpack_require__.bind(null, /*! ./pages/about/about.module */ "./src/app/pages/about/about.module.ts")).then(m => m.AboutModule)
    },
    {
        path: 'login',
    ...
    {
        path: 'app',
        loadChildren: () => Promise.all(/*! import() | pages-tabs-page-tabs-page-module */[__webpack_require__.e("default~pages-about-about-module~pages-tabs-page-tabs-page-module"), __webpack_require__.e("pages-tabs-page-tabs-page-module")]).then(__webpack_require__.bind(null, /*! ./pages/tabs-page/tabs-page.module */ "./src/app/pages/tabs-page/tabs-page.module.ts")).then(m => m.TabsModule)
    },
    {
        path: 'tutorial',
    ...
    {
        path: 'package',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-package-package-module */ "pages-package-package-module").then(__webpack_require__.bind(null, /*! ./pages/package/package.module */ "./src/app/pages/package/package.module.ts")).then(m => m.PackagePageModule)
    },
    {
        path: 'tickets',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-tickets-tickets-module */ "pages-tickets-tickets-module").then(__webpack_require__.bind(null, /*! ./pages/tickets/tickets.module */ "./src/app/pages/tickets/tickets.module.ts")).then(m => m.TicketsPageModule)
    },
    {
        path: 'create-ticket',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-create-ticket-create-ticket-module */ "pages-create-ticket-create-ticket-module").then(__webpack_require__.bind(null, /*! ./pages/create-ticket/create-ticket.module */ "./src/app/pages/create-ticket/create-ticket.module.ts")).then(m => m.CreateTicketPageModule)
    },
    {
        path: 'dashboard',
    ...
    {
        path: 'our-services',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-our-services-our-services-module */ "pages-our-services-our-services-module").then(__webpack_require__.bind(null, /*! ./pages/our-services/our-services.module */ "./src/app/pages/our-services/our-services.module.ts")).then(m => m.OurServicesPageModule)
    },
    {
        path: 'team',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-team-team-module */ "pages-team-team-module").then(__webpack_require__.bind(null, /*! ./pages/team/team.module */ "./src/app/pages/team/team.module.ts")).then(m => m.TeamPageModule)
    },
    {
        path: 'homepage',
    ...
    },
    {
        ...
        loadChildren: () => __webpack_require__.e(/*! import() | pages-view-ticket-view-ticket-module */ "pages-view-ticket-view-ticket-module").then(__webpack_require__.bind(null, /*! ./pages/view-ticket/view-ticket.module */ "./src/app/pages/view-ticket/view-ticket.module.ts")).then(m => m.ViewTicketPageModule)
    },
    {
        path: 'term-condition',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-term-condition-term-condition-module */ "pages-term-condition-term-condition-module").then(__webpack_require__.bind(null, /*! ./pages/term-condition/term-condition.module */ "./src/app/pages/term-condition/term-condition.module.ts")).then(m => m.TermConditionPageModule)
    },
    {
        path: 'reset-passward',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-reset-passward-reset-passward-module */ "pages-reset-passward-reset-passward-module").then(__webpack_require__.bind(null, /*! ./pages/reset-passward/reset-passward.module */ "./src/app/pages/reset-passward/reset-passward.module.ts")).then(m => m.ResetPasswardPageModule)
    },
    {
        path: 'home',
    ...
    {
        path: 'google-login',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-google-login-google-login-module */ "pages-google-login-google-login-module").then(__webpack_require__.bind(null, /*! ./pages/google-login/google-login.module */ "./src/app/pages/google-login/google-login.module.ts")).then(m => m.GoogleLoginPageModule)
    },
    {
        path: 'add-device',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-add-device-add-device-module */ "pages-add-device-add-device-module").then(__webpack_require__.bind(null, /*! ./pages/add-device/add-device.module */ "./src/app/pages/add-device/add-device.module.ts")).then(m => m.AddDevicePageModule)
    },
    {
        path: 'device-options',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-device-options-device-options-module */ "pages-device-options-device-options-module").then(__webpack_require__.bind(null, /*! ./pages/device-options/device-options.module */ "./src/app/pages/device-options/device-options.module.ts")).then(m => m.DeviceOptionsPageModule)
    },
    {
        path: 'adding-device',
        loadChildren: () => __webpack_require__.e(/*! import() | adding-device-adding-device-module */ "adding-device-adding-device-module").then(__webpack_require__.bind(null, /*! ./adding-device/adding-device.module */ "./src/app/adding-device/adding-device.module.ts")).then(m => m.AddingDevicePageModule)
    },
    {
        path: 'switch-options',
        loadChildren: () => __webpack_require__.e(/*! import() | switch-options-switch-options-module */ "switch-options-switch-options-module").then(__webpack_require__.bind(null, /*! ./switch-options/switch-options.module */ "./src/app/switch-options/switch-options.module.ts")).then(m => m.SwitchOptionsPageModule)
    },
    {
        path: 'adding-device',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-adding-device-adding-device-module */ "pages-adding-device-adding-device-module").then(__webpack_require__.bind(null, /*! ./pages/adding-device/adding-device.module */ "./src/app/pages/adding-device/adding-device.module.ts")).then(m => m.AddingDevicePageModule)
    },
    {
        path: 'switch-options',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-switch-options-switch-options-module */ "pages-switch-options-switch-options-module").then(__webpack_require__.bind(null, /*! ./pages/switch-options/switch-options.module */ "./src/app/pages/switch-options/switch-options.module.ts")).then(m => m.SwitchOptionsPageModule)
    },
    {
        path: 'switches',
        loadChildren: () => Promise.all(/*! import() | pages-switches-switches-module */[__webpack_require__.e("default~pages-single-button-single-button-module~pages-switches-switches-module"), __webpack_require__.e("pages-switches-switches-module")]).then(__webpack_require__.bind(null, /*! ./pages/switches/switches.module */ "./src/app/pages/switches/switches.module.ts")).then(m => m.SwitchesPageModule)
    },
    {
        path: 'device-adding',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-device-adding-device-adding-module */ "pages-device-adding-device-adding-module").then(__webpack_require__.bind(null, /*! ./pages/device-adding/device-adding.module */ "./src/app/pages/device-adding/device-adding.module.ts")).then(m => m.DeviceAddingPageModule)
    },
    {
        path: 'login-otp',
    ...
    {
        path: 'single-button',
        loadChildren: () => Promise.all(/*! import() | pages-single-button-single-button-module */[__webpack_require__.e("default~pages-single-button-single-button-module~pages-switches-switches-module"), __webpack_require__.e("pages-single-button-single-button-module")]).then(__webpack_require__.bind(null, /*! ./pages/single-button/single-button.module */ "./src/app/pages/single-button/single-button.module.ts")).then(m => m.SingleButtonPageModule)
    },
    {
        path: 'google-otp',
    ...
    {
        path: 'device-adding1',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-device-adding1-device-adding1-module */ "pages-device-adding1-device-adding1-module").then(__webpack_require__.bind(null, /*! ./pages/device-adding1/device-adding1.module */ "./src/app/pages/device-adding1/device-adding1.module.ts")).then(m => m.DeviceAdding1PageModule)
    },
    {
        path: 'device-adding2',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-device-adding2-device-adding2-module */ "pages-device-adding2-device-adding2-module").then(__webpack_require__.bind(null, /*! ./pages/device-adding2/device-adding2.module */ "./src/app/pages/device-adding2/device-adding2.module.ts")).then(m => m.DeviceAdding2PageModule)
    },
    {
        path: 'device-adding3',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-device-adding3-device-adding3-module */ "pages-device-adding3-device-adding3-module").then(__webpack_require__.bind(null, /*! ./pages/device-adding3/device-adding3.module */ "./src/app/pages/device-adding3/device-adding3.module.ts")).then(m => m.DeviceAdding3PageModule)
    },
    {
        path: 'arihant-demo',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-arihant-demo-arihant-demo-module */ "pages-arihant-demo-arihant-demo-module").then(__webpack_require__.bind(null, /*! ./pages/arihant-demo/arihant-demo.module */ "./src/app/pages/arihant-demo/arihant-demo.module.ts")).then(m => m.ArihantDemoPageModule)
    },
    {
        path: 'profile',
...
/* harmony import */ var _providers_user_data__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./providers/user-data */ "./src/app/providers/user-data.ts");
/* harmony import */ var _services_events__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./services/events */ "./src/app/services/events.ts");
...
let AppComponent = class AppComponent {
    constructor(menu, platform, router, splashScreen, statusBar, authService, alertService, storage, userData, swUpdate, toastCtrl, events) {
        this.menu = menu;
    ...
    backButtonEvent() {
        this.platform.backButton.subscribeWithPriority(999999, () => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
...
AppComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_4__["MenuController"],
        ...
        _providers_user_data__WEBPACK_IMPORTED_MODULE_10__["UserData"],
        _angular_service_worker__WEBPACK_IMPORTED_MODULE_3__["SwUpdate"],
        _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["ToastController"],
        _services_events__WEBPACK_IMPORTED_MODULE_11__["Events"]])
], AppComponent);
...
/* harmony import */ var ionic_color_picker__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ionic-color-picker */ "./node_modules/ionic-color-picker/dist/src/index.js");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        imports: [
            ionic_color_picker__WEBPACK_IMPORTED_MODULE_17__["IonicColorPickerModule"],
...
let AuthService = class AuthService {
    ...
    login(username, password) {
        return this.http.post(this.env.API_URL + 'login', { email: username, password: password })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(username => {
    ...
    reset_password(username) {
        const headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]()
            .set('Authorization', 'Bearer ' + this.token);
        return this.http.post(this.env.API_URL + 'password/email', { email: username });
    }
    ...
    payment(user_id, payment_id, amount, product_id) {
        const headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]().set('Content-Type', 'application/json')
            .set('Accept', 'application/json')
            .set('Authorization', 'Bearer ' + this.token);
        let postData = {
    ...
    register(first_name, last_name, email, phone, password, password_confirmation, is_term_accept) {
...
module.exports = __webpack_require__(/*! E:\githubproject\arihant\src\main.ts */"./src/main.ts");
