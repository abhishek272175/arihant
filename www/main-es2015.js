...
const routes = [
    ...
    {
        path: 'switches',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-switches-switches-module */ "pages-switches-switches-module").then(__webpack_require__.bind(null, /*! ./pages/switches/switches.module */ "./src/app/pages/switches/switches.module.ts")).then(m => m.SwitchesPageModule)
    },
    {
        path: 'device-adding',
